...
const getMargin = function () {
  ...
  let positionProp =
    arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'bottom-left';
  ...
  const vertical =
    (_position$ = position[0]) !== null && _position$ !== void 0 && _position$.includes('top')
      ? {
  ...
  const horizontal =
    (_position$2 = position[1]) !== null && _position$2 !== void 0 && _position$2.includes('right')
      ? {
...
class ToastService {
    ...
    Object.keys(defOptions).forEach((key) => {
      if (key in defOptions) {
        if (key === 'position' && positions.includes(options[key])) {
          ...
          var _options$key;
          if (
            ((_options$key = options[key]) === null || _options$key === void 0
              ? void 0
  ...
  addToast(toast) {
    if (this.toasts.length < 3) {
      ...
      const margin = getMargin(
        options.position,
        options === null || options === void 0 ? void 0 : options.horizontalMargin,
        options === null || options === void 0 ? void 0 : options.verticalMargin,
      );
      const toastOptions = {
        ...options,
        ...margin,
  ...
  getLastToast() {
    var _this$toasts;
    return this.toasts[
      ((_this$toasts = this.toasts) === null || _this$toasts === void 0
        ? void 0
        : _this$toasts.length) - 1
    ];
  }
  getAllToasts() {
    return this.toasts;
...
const StyledButton = styled.button.withConfig({
  ...
  [
    ...
    'px;transition:all 0.5s;&:active{transform:scale(0.87);}background-color:',
    ';color:',
    ';',
  ],
  theme.sizes.width[0],
  theme.sizes.height[0],
  theme.borders.borderRadius[0],
...
const leftRightHide$1 = keyframes([
  'from{transform:translateX(0);}to{transform:translateX(-110vw);}',
]);
const rightLeftHide$1 = keyframes([
  'from{transform:translateX(0);}to{transform:translateX(110vw);}',
]);
...
const leftRight = keyframes([
  '0%{transform:translateX(-100vw);}20%{transform:translateX(10%)}50%{transform:translateX(-10%)}100%{transform:translateX(0%)}',
]);
const rightLeft = keyframes([
  '0%{transform:translateX(110vw);}20%{transform:translateX(-10%);}50%{transform:translateX(10%);}100%{transform:translateX(0);}',
]);
const upDown = keyframes([
  '0%{transform:translateY(-100vh);}20%{transform:translateY(10%);}50%{transform:translateY(-10%);}100%{transform:translateY(0);}',
]);
const downUp = keyframes([
  '0%{transform:translateY(100vh);}20%{transform:translateY(-10%);}50%{transform:translateY(10%);}100%{transform:translateY(0);}',
]);
const leftRightHide = keyframes([
  '0%{transform:translateX(0);}60%{transform:translateX(20%);}100%{transform:translateX(-100vw);}',
]);
const rightLeftHide = keyframes([
  '0%{transform:translateX(0);}60%{transform:translateX(-20%);}100%{transform:translateX(110vw);}',
]);
const upDownHide = keyframes([
  '0%{transform:translateY(0);}60%{transform:translateY(20%);}100%{transform:translateY(-110vh);}',
]);
...
const StyledToast = styled.div.withConfig({
  ...
  [
    "@import url('https://fonts.googleapis.com/css2?family=Anek+Latin:wght@200&display=swap');font-family:'Anek Latin',sans-serif;position:relative;font-weight:700;pointer-events:all;display:flex;justify-content:space-between;pointer-events:all;align-items:center;background-color:",
    ';border-radius:',
    'px;width:',
    'px;min-height:',
    'px;box-shadow:',
    ';padding:',
    'px;justify-content:space-between;color:',
    ';margin-top:',
    'px;',
    ";&[data-animation='left-right-smooth']{animation:0.7s ",
    ";}&[data-animation='right-left-smooth']{animation:0.7s ",
    ";}&[data-animation='up-down-smooth']{animation:0.7s ",
    ";}&[data-animation='down-up-smooth']{animation:0.7s ",
    ";}&[data-animation='left-right-bounce']{animation:0.7s ",
    ";}&[data-animation='right-left-bounce']{animation:0.7s ",
    ";}&[data-animation='up-down-bounce']{animation:0.7s ",
    ";}&[data-animation='down-up-bounce']{animation:0.7s ",
    ";}&.close{&[data-animation='left-right-smooth']{animation:0.7s ",
    ";}&[data-animation='right-left-smooth']{animation:0.7s ",
    ";}&[data-animation='up-down-smooth']{animation:0.7s ",
    ";}&[data-animation='down-up-smooth']{animation:0.7s ",
    ";}&[data-animation='left-right-bounce']{animation:0.7s ",
    ...
    'px;}&::before{content:attr(data-topic);position:absolute;top:4px;}',
  ],
  (_ref) => {
  ...
  (_ref8) => {
    var _space$space;
    let { space } = _ref8;
    return (_space$space = space.space) === null || _space$space === void 0
      ? void 0
      : _space$space.marginTop[0];
  },
  (_ref9) => {
    let { horizontalMargin } = _ref9;
  ...
  (_ref10) => {
    var _space$space2;
    let { space } = _ref10;
    return (_space$space2 = space.space) === null || _space$space2 === void 0
      ? void 0
      : _space$space2.marginRight[5];
  },
);
const StyledToastContent = styled.div.withConfig({
  ...
  (_ref13) => {
    var _space$space3;
    let { space } = _ref13;
    return (_space$space3 = space.space) === null || _space$space3 === void 0
      ? void 0
      : _space$space3.marginRight[0];
  },
);
...
function Toast(_ref) {
  ...
  const animationClass =
    animationType !== null && animationType !== void 0 && animationType.includes('smooth')
      ? 'smooth'
      : 'bounce';
  ...
  return /*#__PURE__*/ jsx(ThemeProvider, {
    ...
    children: /*#__PURE__*/ jsxs(StyledToast, {
      ...
      space: theme,
      children: [
        /*#__PURE__*/ jsxs(StyledToastContent, {
          space: theme,
        ...
        /*#__PURE__*/ jsx(StyledCross, {
          ...
          onClick: handleClose,
          children:
            (_theme$notifications = theme.notifications) === null || _theme$notifications === void 0
              ? void 0
              : _theme$notifications.closeIcon,
        }),
      ],
    }),
  });
...
const StyledSloatsContainer = styled.div.withConfig({
  ...
  [
    'position:fixed;display:flex;flex-direction:column;align-items:flex-end;',
    ';&.top-center{top:0;left:50%;transform:translateX(-50%);}&.top-left{top:0;left:0;}&.top-right{top:0;right:0;}&.bottom-left{bottom:0;left:0;}&.bottom-right{bottom:0;right:0;}&.bottom-center{bottom:0px;left:50%;transform:translateX(-50%);}',
  ],
  (_ref) => {
    let { margin } = _ref;
    return margin;
...
function ToastSlots(_ref) {
  ...
  return /*#__PURE__*/ jsx(StyledSloatsContainer, {
    ...
    children:
      slotsList === null || slotsList === void 0
        ? void 0
        : slotsList.map((item) => {
            return /*#__PURE__*/ jsx(
              Toast$1,
